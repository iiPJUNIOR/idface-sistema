      ...
      <main className="w-full max-w-7xl px-4 sm:px-6 py-6 sm:py-10 relative z-10 space-y-6 sm:space-y-8 flex-1">
        ...
        <div className="glass-panel rounded-2xl sm:rounded-[2rem] border border-white/5 overflow-hidden shadow-2xl flex flex-col min-h-[600px] relative">
          ...
          <div className="p-4 sm:p-8 flex-1 bg-slate-950/40 relative">
            {activeTab === 'users' ? (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-forwards space-y-6 sm:space-y-8">
                {/* Search & Actions */}
                <div className="flex flex-col xl:flex-row items-center justify-between gap-6 p-1">
                  ...
                  <div className="flex w-full xl:w-auto overflow-x-auto sm:flex-wrap items-center gap-3 sm:gap-4 pb-2 sm:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] snap-x shrink-0">
                    ...
                    <button onClick={() => setShowImportModal(true)} className="shrink-0 snap-start flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl font-bold transition-all shadow-lg hover:shadow-indigo-500/40 hover:-translate-y-0.5 text-white tracking-wide text-sm sm:text-base">
                      <Upload className="w-4 h-4 sm:w-6 sm:h-6 shrink-0" /> <span className="whitespace-nowrap">Importar</span>
                    </button>
                    <button onClick={() => openModal()} className="shrink-0 snap-start flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl font-bold transition-all shadow-lg hover:shadow-emerald-500/40 hover:-translate-y-0.5 text-white tracking-wide text-sm sm:text-base">
